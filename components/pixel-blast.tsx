...
// Ported from React Bits PixelBlast (JS+CSS variant)
    ...
    if (mustReinit) {
      ...
      const animate = () => {
        ...
        if (composer) {
          ...
          // Update noise effect time if present
          if (noiseEffect) {
            const u = noiseEffect.uniforms?.get("uTime")
