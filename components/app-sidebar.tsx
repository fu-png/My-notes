        ...
        <div ref={containerRef} className="relative hidden w-full max-w-md md:block">
          <div className="relative">
            ...
            <input
              ...
              placeholder="搜索文件… ⌘K"
              className="h-8 w-full rounded-md border-none bg-muted pl-8 pr-8 text-sm placeholder:text-muted-foreground/60 focus:border focus:border-primary focus:bg-background focus:outline-none"
            />
            {search && (
              <button
