        ...
        <nav className="fixed left-0 right-0 top-0 z-50 border-b border-neutral-200/60 bg-white/80 px-8 py-4 backdrop-blur-xl dark:border-neutral-800/60 dark:bg-neutral-950/80">
          <div className="mx-auto flex max-w-7xl items-center justify-between">
            ...
            <div className="flex items-center gap-8 text-sm">
              ...
              <Link href="/pricing" className="text-[#6F6F6F] transition-colors hover:text-black dark:hover:text-white">定价</Link>
            </div>
            {/* CTA */}
            <NavAuthSection />
          </div>
...
function NavAuthSection() {
  ...
  return (
    <div className="flex items-center gap-3">
      ...
      <Link
        href="/login"
        className="text-sm text-[#6F6F6F] transition-colors hover:text-black dark:hover:text-white"
      >
        登录
      </Link>
      <Link
